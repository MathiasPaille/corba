...
public class RectoratHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, gestionVoeu.Rectorat t)
    {
     ...
     */
    public static gestionVoeu.Rectorat extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return gestionVoeu.RectoratHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:gestionVoeu/Rectorat:1.0";
     ...
     */
    public static gestionVoeu.Rectorat read(org.omg.CORBA.portable.InputStream istream)
    {
        return(gestionVoeu.Rectorat)istream.read_Object(gestionVoeu._RectoratStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, gestionVoeu.Rectorat value)
    {
