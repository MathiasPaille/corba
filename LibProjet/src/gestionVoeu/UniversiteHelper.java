...
public class UniversiteHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, gestionVoeu.Universite t)
    {
     ...
     */
    public static gestionVoeu.Universite extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return gestionVoeu.UniversiteHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:gestionVoeu/Universite:1.0";
     ...
     */
    public static gestionVoeu.Universite read(org.omg.CORBA.portable.InputStream istream)
    {
        return(gestionVoeu.Universite)istream.read_Object(gestionVoeu._UniversiteStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, gestionVoeu.Universite value)
    {
