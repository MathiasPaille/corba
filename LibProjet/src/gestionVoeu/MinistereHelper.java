...
public class MinistereHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, gestionVoeu.Ministere t)
    {
     ...
     */
    public static gestionVoeu.Ministere extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return gestionVoeu.MinistereHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:gestionVoeu/Ministere:1.0";
     ...
     */
    public static gestionVoeu.Ministere read(org.omg.CORBA.portable.InputStream istream)
    {
        return(gestionVoeu.Ministere)istream.read_Object(gestionVoeu._MinistereStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, gestionVoeu.Ministere value)
    {
